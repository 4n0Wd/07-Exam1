...
Authors: David Mutchler, Vibha Alangar, Valerie Galluzzi, Mark Hays,
         Amanda Stouder, their colleagues and Hanyu Yang.
...
def problem3(point, length, delta, window):
    ...
    lineb = rg.Line(point, rg.Point(point.x, point.y + length))
    lineb.color = 'black'
    lineb.thickness = 3
    lineb.attach_to(window)

    # Computing the number of lines that should be drawn
    number = length // delta + 1
